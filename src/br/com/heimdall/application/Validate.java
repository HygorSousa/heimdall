...
public class Validate {
    ...
    public static boolean isEqual(Object objectA, Object objectB) {
        if (isNull(objectA) && isNull(objectB)) {
            ...
            return ((java.util.Date) objectA).getTime() == ((java.util.Date) objectB).getTime();
    ...
    public static boolean isBigger(Object objectBigger, Object objectSmaller, boolean acceptEqual) {
        if (Validate.isDate(objectSmaller)) {
            return Validate.isBigger((java.util.Date) objectBigger, (java.util.Date) objectSmaller, acceptEqual);
    ...
    public static Boolean isBigger(java.util.Date objectBigger, java.util.Date objectSmaller, boolean acceptEqual) {
    ...
    public static Boolean isBigger(java.util.Date objectBigger, java.util.Date objectSmaller) {
        return isBigger(objectBigger, objectSmaller, false);
    }
